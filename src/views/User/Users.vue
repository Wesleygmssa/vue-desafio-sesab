      ...
      <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div class="flex flex-col">
          ...
          <input
            ...
            class="px-4 py-2 border rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:border-[#3448EB] transition"
          />
        </div>

        <!-- CPF -->
        <div class="flex flex-col">
          <label class="text-xs text-gray-500 mb-1">CPF</label>
          <input
            v-model="cpf"
        ...
        <!-- DATA INÍCIO -->
        <div class="flex flex-col">
          <label class="text-xs text-gray-500 mb-1">Data início</label>
          <input
            type="date"
            v-model="dataInicio"
            class="px-4 py-2 border rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:border-[#3448EB] transition"
        ...
        <!-- DATA FIM -->
        <div class="flex flex-col">
          <label class="text-xs text-gray-500 mb-1">Data fim</label>
          <input
            type="date"
            v-model="dataFim"
            class="px-4 py-2 border rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:border-[#3448EB] transition"
        ...
        <div class="flex items-end gap-2">
          <button
            @click="buscarUsers(1)"
            class="cursor-pointer flex-1 py-2.5 rounded-xl text-white font-medium transition hover:scale-[1.02] active:scale-[0.98]"
          ...
          <button
            @click="limparFiltros"
            class="cursor-pointer px-4 py-2.5 rounded-xl border text-gray-600 hover:bg-gray-100 transition"
          >
            Limpar
          </button>
        </div>
